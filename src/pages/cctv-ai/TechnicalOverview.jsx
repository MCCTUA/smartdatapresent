...
// ---------------------------------------------------------------------------
// TechnicalOverview.jsx — /cctv-ai/technical-overview
// Sub-page ของ CCTV + AI · 2 หลักการ A/B + Cloud + LPR demo + Coverage Estimator
// Migrated จาก CCTVAI.jsx เดิม · scrub brand mentions · เนื้อหาเดิมเก็บครบ
// Design: Civic Trust palette · Font: Sarabun · Pricing: NOT in this page
// ---------------------------------------------------------------------------
              ...
              <div className="rounded-xl p-5" style={{ background: '#FFF', border: `1px solid ${C.surfaceSoft}` }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 text-[12px]">
                  <div className="rounded-lg p-3" style={{ background: C.surface, border: `1px solid ${C.surfaceSoft}` }}>
                    <strong style={{ color: C.primary }}>1. กล้อง</strong> — ใช้กล้อง IP รุ่นไหนก็ได้ที่มี RTSP (มาตรฐานเปิด · ใช้ได้ทั่วไปกับ IP camera ในตลาด)
                  </div>
                  <div className="rounded-lg p-3" style={{ background: C.surface, border: `1px solid ${C.surfaceSoft}` }}>
              ...
              <div className="rounded-xl p-5" style={{ background: C.primaryDeep, color: '#FFF' }}>
                ...
                <div className="space-y-3 text-[12.5px] leading-relaxed">
                  ...
                  <div>
                    ...
                    <div style={{ color: '#FFFFFFCC' }}>A: ไม่ต้อง — ถ้ากล้องเดิมเป็น IP camera ที่มี RTSP (มาตรฐานเปิด · ใช้กับ IP camera ทั่วไปในตลาดได้) ใช้ต่อได้เลย</div>
                  </div>
                  <div>
...
export default function TechnicalOverview() {
  return (
    <div className="cctv-app-page" style={{ fontFamily: 'Sarabun, Tahoma, sans-serif', color: C.text, background: C.surface }}>
      {/* Breadcrumb */}
      <div
      ...
      >
        <div className="max-w-[1100px] mx-auto text-[12px] flex items-center gap-1.5 flex-wrap" style={{ color: C.textMuted }}>
          ...
          <span>›</span>
          <span style={{ color: C.primaryDeep, fontWeight: 600 }}>หลักการเทคนิค</span>
        </div>
      </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <motion.div initial="hidden" animate="show" variants={stagger}>
            <motion.div variants={fadeUp}>
              <Eyebrow color={C.accent}>CCTV + AI · หลักการเทคนิค</Eyebrow>
            </motion.div>
            <motion.h1
              variants={fadeUp}
            ...
            >
              <span className="block">เข้าใจหลังบ้านของ CCTV + AI</span>
              <span className="block">ก่อนตัดสินใจ scope ใหญ่</span>
              <span className="block" style={{ color: C.accent }}>2 หลักการ · 1 Cloud option</span>
            </motion.h1>
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
              ...
              <div className="rounded-2xl p-6" style={{ background: '#FFF', border: `1px solid ${C.surfaceSoft}`, borderTop: `4px solid ${C.alert}` }}>
                ...
                <p className="text-[13.5px] leading-relaxed" style={{ color: C.text }}>
                  หลายยี่ห้อ · ของเก่าจากผู้รับเหมาคนเดิม · ปะปนกับของใหม่ — แต่ละยี่ห้อใช้ app คนละตัว · ดูร่วมกันไม่ได้ · ค้นหาข้ามกล้องไม่ได้
                </p>
              </div>
            </motion.div>
